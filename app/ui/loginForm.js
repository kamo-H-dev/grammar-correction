                            ...
                            <div className='divide-y divide-gray-200'>
                                <div
                                    ...
                                    <div className='relative'>
                                        <input autoComplete='off' id='email' name='email' type='email' defaultValue={'grammar-correction@test.com'}
                                    ...
                                    <div className='relative'>
                                        <input autoComplete='off' id='password' name='password' type='password' defaultValue={'12345678'}
                                               className='peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600'
...
function SubmitButton() {
    ...
    return (
        <button className='bg-cyan-500 text-white rounded-md px-2 py-1' disabled={pending} type='submit'>
            Login
        </button>
    );
}
